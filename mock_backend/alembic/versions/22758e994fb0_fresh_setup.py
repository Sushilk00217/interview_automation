...
Revision ID: 22758e994fb0
Revises: 
Create Date: 2026-03-09 11:04:09.351527
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['current_section_id'], ['interview_session_sections.id'], ondelete='SET NULL'),
